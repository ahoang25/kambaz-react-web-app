...
<br />
      <div id="wd-css-styling-switches">
        ...
        <Form.Check type="switch" id="custom-switch-1" label="Unchecked disabled switch checkbox input" disabled />
        <Form.Check type="switch" id="custom-switch-2" label="Checked disabled switch checkbox input" disabled defaultChecked />
      </div>
